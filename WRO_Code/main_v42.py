...
# detection of aruco
    if corners != []:
        ...
        cv2.circle(image, (540, 350), 10, (255, 0, 0), -1)
        cv2.circle(image, (540, 160), 10, (255, 0, 0), -1)
        cv2.circle(image, (100, 160), 10, (255, 0, 0), -1)
        cv2.circle(image, (100, 350), 10, (255, 0, 0), -1)

        # calculating point 1 angle
        cv2.line(image, (centreX, centreY), (540, 350), (255, 255, 0), 2)
        cv2.line(image, (centreX, centreY), (540, 350), (0, 255, 255), 2)
        hip_point = math.sqrt((centreX - 540) ** 2 + (centreY - 350) ** 2)
        kat_point = math.sqrt((centreX - centreX) ** 2 + (centreY - 350) ** 2)
        if hip_point == 0:
        ...
        # statement for checking full clock degree for point 1
            ...
            elif centreX < 540 and centreY > 350:
                angle_degrees_point = 180 + angle_degrees_point
            elif centreX < 540 and centreY < 350:
        ...
        distance_point = int(math.sqrt((centreX - 540) ** 2 + (centreY - 350) ** 2))
        cv2.putText(image, str(distance_point), (560, 80), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 2)

        # calculating point 2 angle
        cv2.line(image, (centreX, centreY), (540, 160), (255, 255, 0), 2)
        cv2.line(image, (centreX, centreY), (540, 160), (0, 255, 255), 2)
        hip_point_2 = math.sqrt((centreX - 540) ** 2 + (centreY - 160) ** 2)
        kat_point_2 = math.sqrt((centreX - centreX) ** 2 + (centreY - 160) ** 2)
        if hip_point_2 == 0:
        ...
        # statement for checking full clock degree for point 2
            ...
            elif centreX < 540 and centreY > 160:
                angle_degrees_point_2 = 180 + angle_degrees_point_2
            elif centreX < 540 and centreY < 160:
        ...
        # dist for point 2
        distance_point_2 = int(math.sqrt((centreX - 540) ** 2 + (centreY - 160) ** 2))
